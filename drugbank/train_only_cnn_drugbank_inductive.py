...
from dataset import load_ddi_dataset,load_ddi_dataset_inductive,load_ddi_dataset_cold_start,load_ddi_dataset_cold_start_structure
from log.train_logger import TrainLogger
from model_copy import SA_DDI_only_cnn as SA_DDI
import argparse
from metrics import *
from utils import *
...
def main():
    ...
    params = dict(
        model='SA-DDI',
        data_root='data/preprocessed/ddi_cold_start',
        save_dir='save_only_cnn_inductive_random',
        dataset='',
        epochs=args.epochs,
        fold=args.fold,
    ...
    train_loader, val_loader, test_loader = load_ddi_dataset_cold_start_structure(root=data_path, batch_size=batch_size, fold=fold)
    ...
    for epoch in tqdm(range(epochs)):
        ...
        # test_s1_loss, test_s1_acc, test_s1_auroc, test_s1_f1_score, test_s1_precision, test_s1_recall, test_s1_ap  = val(model, criterion, test_loader, device)
        # test_s2_loss, test_s2_acc, test_s2_auroc, test_s2_f1_score, test_s2_precision, test_s2_recall, test_s2_ap  = val(model, criterion, test_s2_loader, device)
        ...
        logger.info(msg)
        # msg = "epoch-%d, test_s1_loss-%.4f, test_s1_acc-%.4f, test_s1_auroc-%.4f, test_s1_f1_score-%.4f, test_s1_prec-%.4f, test_s1_rec-%.4f, test_s1_ap-%.4f" % (epoch,  test_s1_loss, test_s1_acc, test_s1_auroc, test_s1_f1_score, test_s1_precision, test_s1_recall, test_s1_ap)
        # logger.info(msg)
        # msg = "epoch-%d, test_s2_loss-%.4f, test_s2_acc-%.4f, test_s2_auroc-%.4f, test_s2_f1_score-%.4f, test_s2_prec-%.4f, test_s2_rec-%.4f, test_s2_ap-%.4f" % (epoch,  test_s2_loss, test_s2_acc, test_s2_auroc, test_s2_f1_score, test_s2_precision, test_s2_recall, test_s2_ap)
        # logger.info(msg)
